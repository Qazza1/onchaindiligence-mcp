...
export interface Attestation {
  ...
  issuer?: string
  purpose?: 'compliance-screening-result' | 'public-action-receipt' | 'erc20-allowance-action' | 'swap-action'
  issued_at?: string
  key_id?: string
  algorithm?: string
...
export async function attest<T>(
  data: T,
  options: { purpose?: 'public-action-receipt' | 'erc20-allowance-action' | 'swap-action' } = {}
